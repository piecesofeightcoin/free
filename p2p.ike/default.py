...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='p2p.ike')
...
def CATEGORIES():
    link = OPEN_URL('https://cld.pt/dl/download/45b464ac-bf55-4676-b57b-853e997cfad6/p2p.ike.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("p2p.ike","Downloading ",'', 'Please Wait')
